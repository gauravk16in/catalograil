    ...
    () => ({
      ...
      async signUp(email, password, businessName) {
        ...
        const result = await signUp({
          ...
          password,
          options: {
            userAttributes: { email, name: businessName },
            /**
             ...
             * navigation and replaying it — which works, and puts a plaintext password in
             * a React tree for as long as someone takes to read a verification email.
             * This asks the identity provider to do it instead, and nothing has to keep
             * the password at all.
             */
            autoSignIn: true,
          },
        ...
        // A pool that needs no confirmation signs in here rather than making the caller
        // guess whether there is a step left.
